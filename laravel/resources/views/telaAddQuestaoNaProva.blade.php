...
<div class="col-md-1"></div>
        ...
        <div class="col-md-2">
            <select class="form-control">
            <option name="turmNV3" id="turmNV3">Discursiva</option>
            <option name="turmNV1" id="turmNV1">Objetiva</option>
        ...
        <div class="col-md-2">
                        ...
                        <a href="#"><button type="button" class="btn btn-default" data-dismiss="modal"> Buscar </button></a>
                    </div>
...
<div class="col-md-10">
  ...
  <table class="table">
    ...
    <tr>
      ...
      <td><input style="color: black;" type="textfield" align="center" name="valor" size="1" maxlength="3" value=""/></td>
